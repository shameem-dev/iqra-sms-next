...
export default function MarksEntryPage() {
  ...
  const [subjectForm, setSubjectForm] = useState<SubjectFormData>(emptySubjectForm(''))
  ...
  // When subjects load, fetch all subjects marks for topper
  // eslint-disable-next-line react-hooks/exhaustive-deps
  useEffect(() => {
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow p-4 mb-6">
        ...
        <select
          ...
          className="w-64 border rounded-lg text-gray-500 px-3 py-2 text-sm"
        >
      ...
      {success && (
        <div className="bg-teal-50 border border-teal-200 text-teal-600 text-sm px-4 py-3 rounded-lg mb-4">
          {success}
        </div>
      )}
      ...
      {loading ? (
      ...
      ) : marksData.length > 0 && activeSubject ? (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-4">
            ...
            {/* Class Topper across all subjects */}
            <ClassTopper
              selectedStandard={selectedStandard}
      ...
      ) : selectedStandard && activeSubject && !loading ? (
        <div className="text-center py-16 text-gray-400">
          No students found in {selectedStandard}.
        </div>
      ) : selectedStandard && subjects.length === 0 && !loading ? (
        <div className="text-center py-16 text-gray-400">
          No subjects found for {selectedStandard}.
          <button
