  ...
  return (
    <div className="flex flex-wrap gap-2 mb-6 items-center">
        ...
        <div key={subject.id} className="relative group">
          ...
          <div className="absolute right-1 top-1/2 -translate-y-1/2 hidden group-hover:flex gap-1">
            ...
            <button
              ...
              className="w-6 h-6 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-400 hover:text-red-500 hover:border-red-300 text-xs shadow-sm"
      ...
      <button
        ...
        className="px-4 py-2 rounded-full text-sm font-medium border border-dashed border-gray-300 text-gray-400 hover:border-teal-400 hover:text-teal-500 transition-all"
      >
        + Add Subject
      </button>
    </div>
